...
function AboutModal({ modal, setModal }) {
    return (
        ...
        >
            ...
            <Modalp>So what'sand computation? John Conway, the creator of this game, pursued creating a virtual simulation that could be classified as alive based on John Von Neumann's definition of living. An organism is capable of self-reproduction and can simulate a Turing machine. This leads to the next major point of this game, Turing complete. To simply put, a system that is designed to solve any computational problem is classified as Turing Complete. Life is Conway's proof that automaton is well alive according to Von Neumann's requirements, an the purpose of this feat of math d as a result brought meaning to 'simulation games'</Modalp>
        </Modal>
    )
